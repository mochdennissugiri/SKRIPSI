...
<head>
  <meta charset="utf-8">
  <title>PENGGUNA BISOC FUTSAL</title>
...
<!-- Menu Atas -->
		        ...
		        <div class="navbar-collapse collapse">
		          <ul class="nav navbar-nav">
		            <li><a href="../../index.php" >Beranda</a></li>
			            ...
			            <li class="active"> <a href="../pengguna/pengguna.php">Pengguna</a></li>
		...
		<div class="container" id="about" name="about">
			<div class="row white">
			   	<br>
			    <h1 class="centered">PENGGUNA LAPANG</h1>
			    <hr>
        ...
        <form cclass="contact-form php-mail-form" action="" method="POST">
            ...
            <div class="form-group">
              <input type="text" name="nama_team" class="form-control" id="contact-name" placeholder="nama team">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
              <input type="text" name="akhir_jam" class="form-control" id="contact-subject" placeholder="akhir jam">
              <div class="validate"></div>
            </div>
