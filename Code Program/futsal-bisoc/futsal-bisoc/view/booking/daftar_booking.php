...
if (isset($_POST['simpan'])){
	...
	$sql = "INSERT INTO booking(nama_team,tanggal_booking,tempat_lapang,mulai_jam,akhir_jam,total_bayar,status_bayar) VALUES('$nama_team','$tanggal_booking','$tempat_lapang','$mulai_jam','$akhir_jam','$total_bayar')";
...
<head>
	...
	<meta charset="utf-8">
 	<title>DAFTAR BOOKING BISOC FUTSAL</title>
...
<body>
	...
	<!-- Menu Atas -->
		        ...
		        <div class="navbar-collapse collapse">
		          <ul class="nav navbar-nav">
		            <li><a href="../../index.php">Beranda</a></li>		       
			            ...
			            <li class="active"> <a href="../booking/daftar_booking.php">Daftar Booking</a></li>
			            <li> <a href="../pengguna/pengguna.php">Pengguna</a></li>
			            <li> <a href="../pengguna/daftar_pengguna.php">Daftar Pengguna</a></li>
		        </div>
		        <!--/.nav-collapse -->
		      </div>
		    </div>
		...
		<div class="container" id="about" name="about">
			<div class="row white">
			   	<br>
			    <h1 class="centered">DAFTAR BOOKING</h1>
			    <hr>
				...
				<?php 
						...
						$queryJadwal = mysqli_query($link, "SELECT * FROM booking");
				...
				<table class="table table-sm" border="3">
					...
					<tbody>
						<tr>
							...
							<td>
								<button type="submit" class="btn btn-large"><a href="edit_booking.php?id=<?= $row['id'];  ?>" type="button">EDIT</a></button>  
								<button type="submit" class="btn btn-large"><a href="hapus_booking.php?id=<?= $row['id'];  ?>" type="button">HAPUS</a></button>
							</td>
						</tr>
