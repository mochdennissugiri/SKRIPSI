...
<body background="bglogin.jpg" style="background-size: cover; ">
	<div  style="width: 400px; margin: 0 auto; "><marquee><p style="color: white; font-size: 30px; font-weight: bold; font-family: 'Ranchers', cursive; letter-spacing: 5px; "> SILAHKAN LOGIN  </p></marquee></div>
	...
	<form class="login100-form validate-form flex-sb flex-w "method="post" action="login/ceklogin.php">
					...
					<center>
						<p>Apakah anda belum punya akun ? Register <a href="register.php" style="color:blue">disini</a></p>
					</center>
